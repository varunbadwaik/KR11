...
import { Trophy, Medal, Award, TrendingUp, TrendingDown, Coins } from 'lucide-react';
...
export function LeaderboardScreen({ onBack }: LeaderboardScreenProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F7FB]">
      {/* Header */}
      <AppHeader onBack={onBack} title="Leaderboard" />
              ...
              <div className="flex items-end justify-center gap-4.5">
                ...
                {rank2 && (
                  <div className="flex flex-col items-center w-[90px]">
                    <div className="relative mb-3">
                      {/* Avatar Circle with Silver Border */}
                    ...
                    <p className="text-[10px] text-[#667085] font-extrabold mt-0.5">{rank2.score.toLocaleString()}</p>
                ...
                {rank1 && (
                  <div className="flex flex-col items-center w-[105px] -mt-5">
                    ...
                    <p className="text-[10.5px] text-[#667085] font-extrabold mt-0.5">{rank1.score.toLocaleString()}</p>
                ...
                {rank3 && (
                  <div className="flex flex-col items-center w-[90px]">
                    <div className="relative mb-3">
                      {/* Avatar Circle with Bronze Border */}
                    ...
                    <p className="text-[10px] text-[#667085] font-extrabold mt-0.5">{rank3.score.toLocaleString()}</p>
                    ...
                    <div className="flex items-center gap-3.5 flex-1 min-w-0">
                      ...
                      <div className="w-8 h-8 flex items-center justify-center flex-shrink-0 select-none">
                        {getRankIcon(player.rank) || (
                          <span className="text-[12px] font-black text-[#9CA3AF]">{player.rank}</span>
                        )}
                      </div>

                      {/* Circle Avatar with Image Fallback */}
                      ...
                      {/* Name & Score & Strategy tag */}
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-black text-[#101828] truncate flex items-center gap-1.5">
                          {player.name}
                          {player.flag && <span className="text-[11px] leading-none select-none">{player.flag}</span>}
                          {player.name === 'Lockie' && (
