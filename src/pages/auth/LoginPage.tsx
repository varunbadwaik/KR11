  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F7FB] overflow-y-auto relative">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.10) 0%, rgba(0,0,0,0.25) 50%, rgba(244,247,251,1) 96%), url(${stadiumBg})`,
        }}
      >
        ...
        <div className="flex flex-col items-center mt-6 select-none relative">
          ...
          <img
            src={logoImg}
            alt="KR11 Logo"
            className="h-20 object-contain relative z-10 drop-shadow-[0_4px_20px_rgba(255,255,255,0.35)]"
          />
        </div>
        ...
        <div className="text-center mt-2.5 select-none relative z-10">
          <h2 className="text-xl font-black tracking-wide leading-none">
            ...
            <span
              className="text-[#E5484D] drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]"
              style={{ textShadow: '0 2px 12px rgba(0,0,0,0.4)' }}
            >
              11
            </span>
          ...
          <p
            className="text-[9px] font-bold uppercase tracking-[0.25em] text-white/90 mt-1"
        ...
        <div className="text-center mt-4 px-4 select-none relative z-10">
          ...
          <h2
            className="text-3xl tracking-tight mt-0.5 leading-none font-black uppercase italic text-white"
        ...
        <div className="flex gap-4 mt-5 z-10 relative select-none px-6">
          {[
            ...
            <div key={label} className="flex flex-col items-center gap-1 flex-1 min-w-[70px]">
              ...
              <span
                className="text-[7.5px] font-extrabold text-white text-center leading-tight max-w-[70px] drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)]"
      ...
      <div className="flex-1 flex flex-col items-center justify-end px-5 pb-6 pt-[42%] relative z-10">
        ...
        <div className="w-full max-w-md bg-white rounded-[2rem] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-[#E5E7EB]/70">
          <h3 className="text-base font-black text-[#101828] mb-0.5 text-center select-none">
            Welcome Back!
          </h3>
          <p className="text-2xs font-semibold text-[#667085] mb-4 text-center select-none">
          ...
          <div className="flex items-center justify-center gap-2.5 mt-5 px-3">
            ...
            <div className="text-[10px] text-[#101828] font-bold leading-normal select-none text-left">
              <p>
                We value your{' '}
                <span className="text-[#2563EB] cursor-pointer hover:underline">policy</span>.
              </p>
              <p>
                Your data is{' '}
                <span className="text-[#2563EB] cursor-pointer hover:underline">safe</span> with us.
              </p>
            </div>
          </div>
        </div>
