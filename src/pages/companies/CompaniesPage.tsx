...
import { CompanySummaryModal } from '../../components/common/CompanySummaryModal';
import { getCompanyIdByName } from '../../utils/companyLookup';
    ...
    <div className="h-full flex flex-col bg-[#F4F7FB]">
      ...
      <div className="bg-transparent px-4 py-4">
        <div className="flex items-center gap-3 mb-4">
          <button
            onClick={() => navigate(-1)}
            className="w-10 h-10 rounded-full bg-transparent hover:bg-black/5 active:scale-95 transition-all text-[#101828] flex items-center justify-center"
            aria-label="Back"
          >
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-4">
          ...
          >
            <div className="flex gap-3 mb-3">
              ...
              <div className="text-right">
                ...
                <p
                  className={`text-xs font-semibold ${company.percentage >= 0 ? 'text-[#14B86A]' : 'text-[#E5484D]'}`}
                >
        ...
        {filteredCompanies.length === 0 && (
          <EmptyState
            ...
            message="Try another search query or sector filter."
          />
        )}
      </div>
