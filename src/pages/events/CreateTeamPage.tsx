...
import { Search, Plus, Minus, X, Eye, ArrowRight, ArrowLeft } from 'lucide-react';
import { BuySellSheet } from '../../components/common/BuySellSheet';
...
import stadiumBg from '../../assets/stadium_background.png';
...
export default function CreateTeamPage() {
        ...
        {item ? (
          <div className="flex flex-col items-center relative">
            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-md border-2 border-white transform hover:scale-105 active:scale-95 transition-all select-none hover:shadow-lg relative">
              ...
              <span
                className={`absolute -top-1.5 -left-1.5 px-1 py-0.25 rounded text-[8px] font-black text-white shadow-sm tracking-wide leading-none ${
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden pt-3 pb-4">
        ...
        <div className="relative z-10 flex flex-col items-center mt-1">
          <img
            src={logoImg}
            alt="KR11"
            className="w-[145px] h-auto object-contain drop-shadow-md"
          />
      ...
      {viewMode === 'list' ? (
        <>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        <p className="text-xs font-extrabold text-[#101828] truncate">
                          {item.companyName}
                        </p>
                        <span
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        onClick={() =>
                          updateQuantity(item.companyId, item.action, item.quantity - 1)
                        }
          ...
          <div className="flex-1 bg-white rounded-t-3xl shadow-[0_-4px_24px_rgba(0,0,0,0.03)] border-t border-[#E5E7EB]/80 mt-4 px-5 pt-5 overflow-y-auto pb-32 space-y-2.5">
            <h3 className="text-xs font-extrabold text-[#667085] uppercase tracking-wider mb-2">
              Stocks
            </h3>
        ...
        <div className="flex-1 flex flex-col pb-36 relative z-10 bg-transparent">
                  ...
                  {item ? (
                    <div className="bg-white rounded-full flex items-center gap-1.5 pl-1.5 pr-2.5 py-1.5 shadow-md border border-white transform hover:scale-105 active:scale-95 transition-all select-none hover:shadow-lg">
                      ...
                      <div className="flex flex-col text-left">
                        <span className="text-[10px] font-black text-[#101828] leading-none max-w-[65px] truncate whitespace-nowrap">
                          {item.companyName}
                        </span>
                        <span
                          className={`text-[7px] font-black tracking-wide leading-none mt-0.5 whitespace-nowrap ${item.action === 'BUY' ? 'text-[#14B86A]' : 'text-[#E5484D]'}`}
                        >
          ...
          {/* Curved Football Pitch Field Container */}
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(circle at top, rgba(255,255,255,0.15) 0%, transparent 60%)',
            }}
          >
            {/* White Pitch Markings SVG Overlay */}
            <svg
              className="absolute inset-0 w-full h-full stroke-white/15 fill-none pointer-events-none"
              viewBox="0 0 100 100"
      ...
      {/* Floating Preview & Submit Footer */}
