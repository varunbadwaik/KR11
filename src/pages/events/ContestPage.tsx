...
import { ArrowLeft, Trophy, Star, Shield, HelpCircle } from 'lucide-react';
...
export default function ContestPage() {
  ...
  const handleJoin = (fee: number) => {
    ...
    navigate(`/events/${encodeURIComponent(eventName)}/create-team`);
  };
    ...
    <div className="h-full flex flex-col bg-[#F4F7FB] select-none">
      ...
      <div className="relative overflow-hidden pt-3 pb-5">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Overlay to match the sky lighting in mockup */}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 pb-20">
        {contestOptions.map((opt) => (
          ...
          >
            ...
            >
              <span className="text-[12px] font-extrabold leading-none whitespace-nowrap">
                {opt.entryFee} Coins
              </span>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h4 className="text-[12.5px] font-black text-white uppercase tracking-wider leading-tight">
                Create Contest
              </h4>
              <p className="text-[9.5px] text-white/60 font-bold tracking-tight">
